...
@section('content')
 ...
 <p><a href="taches/create" class="btn btn-primary" role="butto
n">Ajouter une tâche</a></p>
 </div>
 ...
 {{-- dd($tache) --}}
    ...
    <a href="taches/{{$tache->id}}" class="btnbtn-danger" role="button">
    <span class="far fa-trash-alt fa-2x" aria-hidden="true"></span></a></div></td>
    </tr>
@endforeach
</tbody>
</table>
